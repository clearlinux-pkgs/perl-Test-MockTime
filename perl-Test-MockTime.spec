...
Requires: perl-Test-MockTime-man
...
%package man
Summary: man components for the perl-Test-MockTime package.
Group: Default

%description man
man components for the perl-Test-MockTime package.
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/Test/MockTime.pm
